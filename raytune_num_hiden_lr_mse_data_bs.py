...
if __name__ == "__main__":
    ...
    search_space = {
        # "num_h": tune.grid_search([64, 128, 256]),
        "num_h": tune.grid_search([128]),
        "lr": tune.grid_search([0.0015, 0.0045, 0.009]),
        # "lr": tune.grid_search([0.005]),
        "mse_factor": tune.grid_search([50, 60, 70, 80]),
        # "mse_factor": tune.grid_search([10]),
        # "num_train": tune.grid_search([700, 1000, 1200, 1500]),
    ...
    tuner = tune.Tuner(
        ...
        run_config=RunConfig(
            name="TuneTest_3loss_mse_have_L",
            storage_path="/home/cn/RPSN_4/work_dir/raytune_num_lr_mse/mlp3_attn",
            stop={
                "acc": 0.8
            }
        )
